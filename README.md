...
Active Directory Project - The goal of this project is to create an active directory environment and integrate Splunk ,Slack, Shuffle(SOAR) to Automate Responsive Action
